...
public static class SeedData
{
    ...
    public static readonly Guid CibAccountId = Guid.Parse("11111111-1111-1111-1111-111111111111");
    public static readonly Guid VodafoneAccountId = Guid.Parse("22222222-2222-2222-2222-222222222222");
    ...
    public static async Task InitializeAsync(IServiceProvider services)
    {
        ...
        if (!context.Transactions.Any())
        {
            ...
            var transactions = new List<Transaction>
            {
                ...
                new() { UserId = userId, AccountId = null, Amount = 350.00m, MerchantName = "Street Vendor", Category = "Food", Source = "OCR", Status = "Pending", IsSubscription = false, TransactionDate = now.AddDays(-4), RawAiData = "{\"confidence\":0.82,\"items\":[\"lunch\",\"drinks\"]}" },
                ...
                new() { UserId = userId, AccountId = null, Amount = 75.00m, MerchantName = "Pharmacy", Category = "Health", Source = "Manual", Status = "Confirmed", IsSubscription = false, TransactionDate = now.AddDays(-2) },
